...
public class MyClass {
	...
	public static void main(String[] args) {
		...
		// "getDetailsStatic()" should be called using the CLASS NAME because this method is STATIC.
		// "getDetailsStatic()" can also be called using any instance of the Student class, but it's not preferred.
