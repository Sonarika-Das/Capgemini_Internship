...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		MyBank def = new Bank_DEF();	// This is possible only because MyBank is a super class to Bank_ABC (called Inheritance)
		MyBank ghi = new Bank_GHI();	// "abc", "def", "ghi" are all object handles of the Super Class MyBank and they point to different classes in the package.
										// This property is called Polymorphism
		
		//------------------------------------------------------------------------------------------------------------------------------------------------------
		
		//MyBank par = new MyBank();	// Since MyBank is an abstract class, we can't create an instance of this class.
										// Hence, an ABSTRACT CLASS CAN'T BE INSTANTIATED
										// Rather, we can make an object handle or reference (like "abc") of this class that can point to other non-abstract class
		...
		//System.out.println("Interest rate of the virtual entity Bank = " + par.getInterest()); 
		...
		// This "getInterest()" method also has the same return type and same number of passing arguments (0 in this case)
